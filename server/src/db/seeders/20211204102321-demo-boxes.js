    ...
    const Boxes = await Box.bulkCreate([
      ...
      { name: '416 Christmas Box',
        ...
        { name: 'Alo Goodies',
          ...
          end_date: new Date (2021, 11, 10, 20, 40),
        ...
        { name: 'Jacob & Co Box',
          ...
          price: 11,
          start_date: new Date (2021, 11, 10, 17, 00),
          end_date: new Date (2021, 11, 10, 21, 15),
        ...
        { name: 'Elm Tree Deserts',
          ...
          price: 7,
          start_date: new Date (2021, 11, 10, 16, 00),
          end_date: new Date (2021, 11, 10, 22, 45),
          store_id: Stores.find((el) => el.email === 'elmtree@gmail.com').id,
          createdAt: new Date()
        },
        { name: 'Mystery Canoe Box',
          ...
          end_date: new Date (2021, 11, 10, 20, 35),
          store_id: Stores.find((el) => el.email === 'canoe@gmail.com').id,
          createdAt: new Date()
        },
        { name: 'Campechano Box',
        ...
        { name: 'Box from Yasu with Love',
          ...
          end_date: new Date (2021, 11, 10, 21, 45),
        ...
        { name: 'Swan Mystery Box',
          ...
          end_date: new Date (2021, 11, 10, 23, 45),
          store_id: Stores.find((el) => el.email === 'swan@gmail.com').id,
          createdAt: new Date()
        },
      ...
      { name: 'Box from George',
          ...
          price: 8,
          start_date: new Date (2021, 11, 10, 17, 00),
          end_date: new Date (2021, 11, 10, 22, 30),
      ...
      { name: '416 Box',
        ...
        price: 4,
        start_date: new Date (2021, 11, 10, 12, 00),
        end_date: new Date (2021, 11, 10, 23, 40),
        store_id: Stores.find((el) => el.email === '416@gmail.com').id,
        createdAt: new Date()
        },
