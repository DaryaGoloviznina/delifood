    ...
    const Stores = await Store.bulkCreate(
      ...
      const Boxes = await Box.bulkCreate([
        { name: 'Campechano Box',
          ...
          count: 2,
          price: 5,
          start_date: new Date (2021, 11, 8, 17, 30),
          end_date: new Date (2021, 11, 8, 21, 30),
        ...
        { name: 'Campechano Box',
          ...
          count: 1,
          price: 10,
          start_date: new Date (2021, 11, 8, 13, 30),
          end_date: new Date (2021, 11, 8, 23, 30),
          store_id: Stores.find((el) => el.email === 'campechano@gmail.com').id,
          createdAt: new Date()
        },
        { name: 'Yasu Box',
          ...
          count: 1,
          price: 7,
          start_date: new Date (2021, 11, 8, 17, 0),
          end_date: new Date (2021, 11, 8, 21, 0),
        ...
        { name: 'Yasu Box',
          ...
          count: 1,
          price: 2,
          start_date: new Date (2021, 11, 8, 20, 0),
          end_date: new Date (2021, 11, 8, 21, 0),
          store_id: Stores.find((el) => el.email === 'yasu@gmail.com').id,
          createdAt: new Date()
        },
        { name: 'Yasu Box',
          ...
          count: 1,
          price: 15,
          start_date: new Date (2021, 11, 8, 15, 0),
          end_date: new Date (2021, 11, 8, 19, 0),
          store_id: Stores.find((el) => el.email === 'yasu@gmail.com').id,
          createdAt: new Date()
        },
        { name: 'Bar Box',
          ...
          count: 6,
          price: 3,
          start_date: new Date (2021, 11, 8, 14, 30),
          end_date: new Date (2021, 11, 8, 20, 0),
        ...
        { name: 'Byblos Box',
          ...
          count: 1,
          price: 5,
          start_date: new Date (2021, 11, 8, 19, 0),
          end_date: new Date (2021, 11, 8, 21, 0),
        ...
        { name: 'Byblos Box',
          ...
          count: 1,
          price: 4,
          start_date: new Date (2021, 11, 8, 19, 30),
          end_date: new Date (2021, 11, 8, 20, 0),
          store_id: Stores.find((el) => el.email === 'barrr@gmail.com').id,
          createdAt: new Date()
        },
